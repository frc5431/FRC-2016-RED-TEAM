...
/**
 * Class which contains all of the user input, including a {@linkplain Joystick joystick}.
...
public final class InputMap {
	...
	/**
	 * Check the {@linkplain JoystickButton button} for shooting is down, and returns it.
	 * 
	...
	/**
	 * Check the {@linkplain JoystickButton button} for the intake is down, and returns it.
	 * 
